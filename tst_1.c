...
static void test_1(void **state) {
    result = function_H(9999, 9999, 9999, 9999, 0);
    assert_int_equal(result ,1);
}

static void test_2(void **state) {
    result = function_H(123, 123, 123, 123, 0);
    assert_int_equal(result ,0);
}

static void test_3(void **state) {
    result = function_H(123, 9999, 9999, 9999, 0);
    assert_int_equal(result ,1);
}

static void test_4(void **state) {
    result = function_H(9999, 123, 9999, 9999, 0);
    assert_int_equal(result ,1);
}

static void test_5(void **state) {
    result = function_H(9999, 9999, 123, 9999, 0);
    assert_int_equal(result ,1);
}

static void test_6(void **state) {
    result = function_H(9999, 9999, 9999, 123, 0);
    assert_int_equal(result ,1);
}

static void test_7(void **state) {
    result = function_H(123, 123, 9999, 9999, 0);
    assert_int_equal(result ,0);
}

static void test_8(void **state) {
    result = function_H(123, 9999, 123, 9999, 0);
    assert_int_equal(result ,0);
}

static void test_9(void **state) {
    result = function_H(123, 123, 123, 9999, 0);
    assert_int_equal(result ,0);
}
